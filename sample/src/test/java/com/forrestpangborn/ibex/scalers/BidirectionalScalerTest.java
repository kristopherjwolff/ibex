...
public class BidirectionalScalerTest extends TestCase {

	private BidirectionalScaler scaler;
	...
	@Test
	public void testScaleUpSquareToSquare() {
		Bitmap orig = Bitmap.createBitmap(10, 10, Config.ARGB_8888);
		Bitmap bmp = scaler.scale(orig, 20, 20);
		assertEquals(20, bmp.getWidth());
		assertEquals(20, bmp.getHeight());
	...
	@Test
	public void testScaleUpWidthBased() {
		Bitmap orig = Bitmap.createBitmap(10, 5, Config.ARGB_8888);
		Bitmap bmp = scaler.scale(orig, 20, 20);
		assertEquals(20, bmp.getWidth());
		assertEquals(10, bmp.getHeight());
	}
	...
	@Test
	public void testScaleUpHeightBased() {
		Bitmap orig = Bitmap.createBitmap(5, 10, Config.ARGB_8888);
		Bitmap bmp = scaler.scale(orig, 20, 20);
		assertEquals(10, bmp.getWidth());
		assertEquals(20, bmp.getHeight());
	}
